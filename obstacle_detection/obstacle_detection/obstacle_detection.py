...
WARNING = 4.5  # Warning distance threshold: 10 meters
CRITICAL = 2.0  # Critical distance threshold: 3 meters

# Parameters for region filtering
left_bound = 1   # Exclude the left 2 columns
right_bound = 1  # Exclude the right 2 columns
